...
// ============================================================================
import { PHRASES, EMERGENCY, PACKING, CURRENCY, TIPS, allPois } from './data.js';
import { el, clear, icon, store, favs, toast, gmapPlace, gmapHotels } from './util.js';
...
function renderTool(key) {
  const map = { phrase: renderPhrase, emergency: renderEmergency, currency: renderCurrency, pass: renderPass, packing: renderPacking, bookings: renderBookings, favs: renderFavs, etiquette: renderEtiquette };
  (map[key] || renderHome)();
  body().scrollTop = 0;
}
