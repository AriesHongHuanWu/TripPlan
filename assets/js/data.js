...
export let CITIES = [
  {
    ...
    pois: [
      ...
      { name: 'くまモンスクエア', jp: 'Kumamon Square', lat: 32.7975, lng: 130.7080, emoji: '🐻', tag: 'see', desc: 'くまモン的辦公室與賣店；部長見面會時間每日不同（多在午後、不定期），出發前請查官方「在室スケジュール」。', hours: '10:00–19:00（不定休）', fee: '免費' },
  ...
  },
  {
    ...
    pois: [
      ...
      { name: '大阪城', jp: 'Osaka Castle', lat: 34.6873, lng: 135.5259, emoji: '🏯', tag: 'see', desc: 'JR 大阪城公園站步行約 15 分；建議線上購票避排隊。', hours: '09:00–18:00（末入 17:30）', fee: '¥1,200' },
...
export let ROUTES = [
  ...
  },
  {
    ...
    legs: [
      { dep: '08:40', arr: '09:35', line: '快速マリンライナー', type: 'rapid', dur: '約 55 分', note: '每 30 分一班；普通車指定席可用周遊券免費劃位。1 號車雙層的上層為「綠色車廂(Green)」，需另購綠色車廂券（周遊券不含）。' },
    ],
...
export let DAYS = [
  D('2026-06-17', '三', 'kumamoto', 'kumamoto', '抵達熊本 · 熊本城', '桃園 06:00 早班機約 9 點抵熊本，巴士進城；熊本城、城彩苑午餐、くまモン、水前寺，一整天玩好玩滿。', [
    ...
    { time: '14:45', type: 'see', title: 'くまモンスクエア', lat: 32.7975, lng: 130.7080, desc: '部長見面會時間每日不同（多為午後、不定期）；想看本人請先查官方在室スケジュール並提早到。賣店掃くまモン伴手禮。', cost: '免費', dur: '60 分' },
  ...
  D('2026-06-18', '四', 'fukuoka', 'fukuoka', '熊本 → 博多 · 太宰府', '新幹線到博多（此段另購），太宰府天滿宮、櫛田／運河城，夜訪中洲屋台。', [
    ...
    { time: '10:30', type: 'move', title: '博多 → 太宰府', desc: '地下鐵到天神轉西鐵電車到太宰府。', route: { fromStn: '西鉄福岡（天神）駅', toStn: '太宰府駅', legs: [{ dep: '10:30', arr: '11:10', line: '地下鐵＋西鐵（二日市轉乘）', type: 'private', dur: '約 35–40 分', note: '¥210＋¥420；西鐵非 JR，不含周遊券。' }], fare: '¥630', pass: '（西鐵不含 JR Pass）' } },
    { time: '11:15', type: 'see', title: '太宰府天滿宮', jp: 'Dazaifu Tenmangū', lat: 33.5214, lng: 130.5350, desc: '學問之神；參道梅ヶ枝餅必嚐。本殿大改修主體已完工（2026/5 媒體公開），但常設參拜預計 9 月起恢復；6 月仍於臨時參拜所參拜。', cost: '境內免費', dur: '2 小時' },
